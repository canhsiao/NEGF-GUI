...
class Setup(QtGui.QWidget):
    ...
    def state(self):
        ...
        input_setup_lines += '\n# *****Occupation *****\n\n'
        input_setup_lines += 'occupations_type = "'           + self._occ.currentText() +'"\n'
        input_setup_lines += 'occupation_electron_temperature_eV = "'             + str(self._occtem.text()) +'"\n'
        input_setup_lines += 'occupation_number_mixing = "'             + str(self._occmix.text()) +'"\n'

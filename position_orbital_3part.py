...
def position_orbital_3part(conf1, conf2,conf3, num_orbital_dict, orbital_radius_dict):
    """
...
""" %(a,b,c)
    ...
    for name,v in zipped_coordinates2:
        _positions_line += ( _atom_format % (name, v[0]+a1,v[1],v[2]) )
    ...
    for name,v in zipped_coordinates1:
        ...
        _positions_line += '  1  1  \n'
    for name,v in zipped_coordinates2:
        _positions_line += ( _orbital_format % (num_orbital_dict[name], v[0]+a1,v[1],v[2]) )
        _positions_line +=  orbital_radius_dict[name]
        _positions_line += '  1  1  \n'
    for name,v in zipped_coordinates3:
    ...
    num_atoms = len(_elements1) +  len(_elements2) +  len(_elements3) 
